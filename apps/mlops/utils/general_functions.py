...
class ImdbSentimentTextModificator:
    ...
    """
    def __new__(cls, review: str, *args, **kwargs):
    ...
    @staticmethod
    def get_abbreviations_wordlist():
    ...
    def accented_chars_remover(self):
    ...
    def special_chars_remover(self):
    ...
    def misspelled_words_proofreader(self):
