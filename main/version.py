...
__logs__        =  {
    'version':      "0.1.0",
    'date':         "08/08/2021",
    'info':         ["Pipeline, preprocessing, model loader, file loader and model input ready for fashion mnist and generics models.", "Custom typing for some values.", "PEP8.", "The code was cleaned up."],
